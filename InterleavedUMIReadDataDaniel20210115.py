...
class InterleavedUMIReadDataDaniel20210115(ReadData):
  '''
  Information associated with a Read from a 'tab' file from with interleaved UMI and Well ID as used by 15 base version in experiment Daniel sent 20210115
  '''
  # constants
